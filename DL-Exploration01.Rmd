...
bind_rows(
  ...
  read_tsv("method_3.csv", n_max=n_max, show_col_types = F),
  read_tsv("method_4.csv", n_max=n_max, show_col_types = F),
  read_tsv("method_5.csv", n_max=n_max, show_col_types = F),
  read_tsv("method_6.csv", n_max=n_max, show_col_types = F),
  read_tsv("method_7.csv", n_max=n_max, show_col_types = F),
  read_tsv("method_8.csv", n_max=n_max, show_col_types = F)
) %>% 
  rename(ID="...1") -> predictions
```
